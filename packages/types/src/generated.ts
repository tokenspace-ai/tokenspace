...
export const BUILTINS_LOCAL = `/** Sleep for a given number of milliseconds */
...
`;
export const BUILTINS_SERVER = `/** Sleep for a given number of milliseconds */
declare function sleep(ms: number): Promise<void>;
...
type UserLookup = { id: string; email?: never } | { email: string; id?: never };
...
declare function isApprovalRequest(error: Error | unknown): error is ApprovalRequiredError;
`;
export const BUILTINS = BUILTINS_SERVER;
