...
- Updated dependencies [fc5f745]
  - @tokenspace/types@0.3.0
  - @tokenspace/system-content@0.3.0
...
- c1ccfed: Add SDK access to the execution session filesystem with `getSessionFilesystem()`, and ensure runtime executions share the same filesystem facade between capability code and builtin `fs`.
  ...
  - @tokenspace/types@0.2.1
  - @tokenspace/system-content@0.2.1

## 0.2.0

### Patch Changes

- @tokenspace/types@0.2.0
- @tokenspace/system-content@0.2.0

## 0.1.2

### Patch Changes

- @tokenspace/types@0.1.2
- @tokenspace/system-content@0.1.2

## 0.1.1

### Patch Changes

- @tokenspace/types@0.1.1
- @tokenspace/system-content@0.1.1
